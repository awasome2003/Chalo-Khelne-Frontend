  ...
  return (
    <div className="min-h-screen">
      ...
      <button
        ...
        className="fixed bottom-6 bg-indigo-600 right-6 text-white w-14 h-14 rounded-full shadow-lg flex items-center justify-center hover:bg-indigo-700 transition"
              ...
              <div className="flex justify-between items-center border-t pt-3 text-sm text-gray-500">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex text-[#333] items-center gap-1 group"
                  >
                  ...
                  <button className="flex text-[#333] items-center gap-1 group">
